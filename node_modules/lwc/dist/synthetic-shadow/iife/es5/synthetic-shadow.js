(function () {
  ...
  var _prototype = Array.prototype, ArrayFilter = _prototype.filter, ArrayFind = _prototype.find, ArrayIndexOf = _prototype.indexOf, ArrayJoin = _prototype.join, ArrayMap = _prototype.map, ArrayPush = _prototype.push, ArrayReduce = _prototype.reduce, ArrayReverse = _prototype.reverse, ArraySlice = _prototype.slice, ArraySplice = _prototype.splice, ArrayUnshift = _prototype.unshift, forEach = _prototype.forEach;
  var _prototype1 = String.prototype, StringCharCodeAt = _prototype1.charCodeAt;
  ...
  var DOCUMENT_POSITION_CONTAINED_BY = _Node.DOCUMENT_POSITION_CONTAINED_BY, DOCUMENT_POSITION_CONTAINS = _Node.DOCUMENT_POSITION_CONTAINS, DOCUMENT_POSITION_PRECEDING = _Node.DOCUMENT_POSITION_PRECEDING, DOCUMENT_POSITION_FOLLOWING = _Node.DOCUMENT_POSITION_FOLLOWING, ELEMENT_NODE = _Node.ELEMENT_NODE, TEXT_NODE = _Node.TEXT_NODE, CDATA_SECTION_NODE = _Node.CDATA_SECTION_NODE, PROCESSING_INSTRUCTION_NODE = _Node.PROCESSING_INSTRUCTION_NODE, COMMENT_NODE = _Node.COMMENT_NODE;
  var appendChild = nodePrototype.appendChild, cloneNode = nodePrototype.cloneNode, compareDocumentPosition = nodePrototype.compareDocumentPosition, insertBefore = nodePrototype.insertBefore, removeChild = nodePrototype.removeChild, replaceChild = nodePrototype.replaceChild, hasChildNodes = nodePrototype.hasChildNodes;
  ...
  var isConnected = hasOwnProperty.call(nodePrototype, "isConnected") ? getOwnPropertyDescriptor(nodePrototype, "isConnected").get : function isConnected() {
   ...
   * SPDX-License-Identifier: MIT
   * For full license text, see the LICENSE file in the repo root or https://opensource.org/licenses/MIT
   */ var _prototype2 = Element.prototype, getAttribute = _prototype2.getAttribute, getBoundingClientRect = _prototype2.getBoundingClientRect, getElementsByTagName$1 = _prototype2.getElementsByTagName, getElementsByTagNameNS$1 = _prototype2.getElementsByTagNameNS, hasAttribute = _prototype2.hasAttribute, querySelector = _prototype2.querySelector, querySelectorAll$1 = _prototype2.querySelectorAll, removeAttribute = _prototype2.removeAttribute, setAttribute = _prototype2.setAttribute;
  ...
  var _prototype3 = HTMLElement.prototype, getElementsByClassName$1 = _prototype3.getElementsByClassName;
  ...
  var _prototype4 = Document.prototype, createComment = _prototype4.createComment, querySelectorAll = _prototype4.querySelectorAll, getElementById = _prototype4.getElementById, getElementsByClassName = _prototype4.getElementsByClassName, getElementsByTagName = _prototype4.getElementsByTagName, getElementsByTagNameNS = _prototype4.getElementsByTagNameNS;
  ...
  var isInstanceOfNativeShadowRoot = isNull(NativeShadowRoot) ? function() {
      ...
      return _instanceof(node, NativeShadowRoot);
  };
  /*
   * Copyright (c) 2018, salesforce.com, inc.
   * All rights reserved.
  ...
  function apply$4() {
      ...
      var _$HTMLSlotElement = function _$HTMLSlotElement() {
          _classCallCheck(this, _$HTMLSlotElement);
      };
      // prototype inheritance dance
      setPrototypeOf(_$HTMLSlotElement, HTMLElement.constructor);
      setPrototypeOf(_$HTMLSlotElement.prototype, HTMLElement.prototype);
      Window.prototype.HTMLSlotElement = _$HTMLSlotElement;
      ...
      defineProperty(Document.prototype, "createElement", {
          value: function value(tagName, _options) {
              ...
              if (tagName.length === 4 && StringCharCodeAt.call(tagName, 0) === CHAR_S && StringCharCodeAt.call(tagName, 1) === CHAR_L && StringCharCodeAt.call(tagName, 2) === CHAR_O && StringCharCodeAt.call(tagName, 3) === CHAR_T) {
                  ...
                  setPrototypeOf(elm, _$HTMLSlotElement.prototype);
              }
              return elm;
          }
      });
  ...
  function isNodeSlotted(host, node) {
      if (process.env.NODE_ENV !== "production") {
          ...
          assert.invariant(_instanceof(node, _Node), "isNodeSlotted() should be called with a node as the second argument instead of ".concat(node));
  ...
  function isNodeOwnedBy(owner, node) {
      if (process.env.NODE_ENV !== "production") {
          ...
          assert.invariant(_instanceof(node, _Node), "isNodeOwnedBy() should be called with a node as the second argument instead of ".concat(node));
  ...
  function getFilteredChildNodes(node) {
      ...
      if (isSyntheticShadowHost(node)) {
          ...
          // slot element
          var children1 = arrayFromCollection(childNodesGetter.call(node));
          var resolver1 = getShadowRootResolver(node);
          return ArrayFilter.call(children1, function(child) {
              return resolver1 === getShadowRootResolver(child);
          });
      }
  }
  ...
  }), _defineProperty(_obj, Symbol.toStringTag, {
      configurable: true,
      get: function get() {
          return "NodeList";
      }
  ...
  var _obj1;
  StaticHTMLCollection.prototype = create(HTMLCollection.prototype, (_obj1 = {
      constructor: {
          writable: true,
          configurable: true,
   ...
   */ var getDocumentOrRootNode = !isUndefined(nativeGetRootNode) ? nativeGetRootNode : function getDocumentOrRootNode() {
      var node = this;
      var nodeParent;
  ...
  var getInternalChildNodes = process.env.NODE_ENV !== "production" && isFalse(hasNativeSymbolSupport) ? function getInternalChildNodes(node) {
   ...
   */ function pathComposer(startNode, composed) {
      ...
      if (_instanceof(startNode, Window)) {
          startRoot = startNode;
      } else if (_instanceof(startNode, _Node)) {
      ...
      while(!isNull(current)){
          ...
          if (_instanceof(current, Element) || _instanceof(current, Text)) {
          ...
          } else if (_instanceof(current, _Node)) {
              current = current.parentNode;
          } else {
              // could be Window
              current = null;
  ...
  */ function retarget(refNode, path) {
   ...
   * For full license text, see the LICENSE file in the repo root or https://opensource.org/licenses/MIT
   */ function apply$2() {
      var PatchedEvent = // Patch Event constructor to add the composed property on events created via new Event.
  ...
  var _prototype6 = OriginalMutationObserver.prototype, originalDisconnect = _prototype6.disconnect, originalObserve = _prototype6.observe, originalTakeRecords = _prototype6.takeRecords;
   ...
   * @param {Node} target
   */ function isQualifiedObserver(observer1, target) {
      var parentNode = target;
      while(!isNull(parentNode)){
          var parentNodeObservers = getNodeObservers(parentNode);
          if (!isUndefined(parentNodeObservers) && (parentNodeObservers[0] === observer1 || ArrayIndexOf.call(parentNodeObservers, observer1) !== -1)) {
              return true;
          }
      ...
      return ArrayReduce.call(mutations, function(filteredSet, record) {
          ...
          if (type === "childList" && !isUndefined(getNodeKey(target))) {
              ...
              if (addedNodes.length > 0) {
                  ...
                  var sampleNode1 = removedNodes[0];
                  if (getNodeNearestOwnerKey(target) === getNodeNearestOwnerKey(sampleNode1) && isQualifiedObserver(observer2, target) // use target as a close enough reference to climb up
                  ) {
                      ArrayPush.call(filteredSet, record);
                  } else if (shadowRoot) {
  ...
  function getWrappedCallback(callback) {
      ...
      if (isUndefined(wrappedCallback)) {
          wrappedCallback = callback[wrapperLookupField] = function(mutations, observer3) {
              // Filter mutation records
              var filteredRecords = filterMutationRecords(mutations, observer3);
              // If not records are eligible for the observer, do not invoke callback
              if (filteredRecords.length === 0) {
                  return;
              }
              callback.call(observer3, filteredRecords, observer3);
          };
      }
   ...
   */ function PatchedMutationObserver(callback) {
      ...
      var observer4 = new OriginalMutationObserver(wrappedCallback);
      return observer4;
  }
  ...
  function patchedTargetGetter() {
      ...
      if (!_instanceof(originalTarget, _Node)) {
          return originalTarget;
      }
      var doc = getOwnerDocument(originalTarget);
      var composedPath3 = pathComposer(originalTarget, this.composed);
   ...
   */ function retargetRelatedTarget(Ctor) {
      ...
      defineProperty(Ctor.prototype, "relatedTarget", {
          get: function get() {
              ...
              if (!_instanceof(relatedTarget, _Node) || !isNodeShadowed(relatedTarget)) {
  ...
  function assignedSlotGetterPatched() {
      ...
      if (_instanceof(parentNode, Element)) {
          var sr = shadowRootGetter.call(parentNode);
          if (isInstanceOfNativeShadowRoot(sr)) {
              if (_instanceof(this, Text)) {
  ...
  function querySelectorPatched() {
      ...
      if (isSyntheticShadowHost(this)) {
          ...
          if (!isUndefined(ownerKey)) {
              ...
              var elm4 = ArrayFind.call(nodeList, function(elm) {
                  return getNodeNearestOwnerKey(elm) === ownerKey;
              });
              return isUndefined(elm4) ? null : elm4;
          } else {
              ...
              var elm1 = ArrayFind.call(nodeList, function(elm) {
                  return getNodeNearestOwnerKey(elm) === contextNearestOwnerKey;
              });
              return isUndefined(elm1) ? null : elm1;
          }
      } else {
          var _this = this;
          if (!runtimeFlags.ENABLE_NODE_LIST_PATCH) {
          ...
          var elm3 = ArrayFind.call(nodeList, function(elm) {
              return isUndefined(getNodeOwnerKey(elm)) || isGlobalPatchingSkipped(_this);
          });
          return isUndefined(elm3) ? null : elm3;
      }
  }
  function getFilteredArrayOfNodes(context, unfilteredNodes, shadowDomSemantic) {
      ...
      if (isSyntheticShadowHost(context)) {
          ...
          if (_instanceof(context, HTMLBodyElement) || shadowDomSemantic === 1) {
  ...
  var formElementTagNames = new Set([
      "BUTTON",
      "INPUT",
      "SELECT",
      "TEXTAREA"
  ...
  function isVisible(element) {
      var ref = getBoundingClientRect.call(element), width = ref.width, height = ref.height;
  ...
  function hostElementFocus() {
      ...
      while(!didFocus && focusables.length !== 0){
          var focusable1 = focusables.shift();
          // @ts-ignore type-mismatch
          focusable1.focus.apply(focusable1, arguments);
          // Get the root node of the current focusable in case it was slotted.
          var currentRootNode = focusable1.getRootNode();
          didFocus = currentRootNode.activeElement === focusable1;
      }
  }
   ...
   * SPDX-License-Identifier: MIT
   * For full license text, see the LICENSE file in the repo root or https://opensource.org/licenses/MIT
   */ var _prototype7 = HTMLElement.prototype, blur = _prototype7.blur, focus = _prototype7.focus;
  /**
  ...
  function initPortalObserver() {
      return new MO(function(mutations) {
          forEach.call(mutations, function(mutation) {
              ...
              for(var i2 = 0, len1 = addedNodes.length; i2 < len1; i2 += 1){
                  var node1 = addedNodes[i2];
                  if (compareDocumentPosition.call(elm, node1) & _Node.DOCUMENT_POSITION_CONTAINED_BY) {
                      adoptChildNode(node1, fn, shadowToken);
                  }
              }
          });
      });
