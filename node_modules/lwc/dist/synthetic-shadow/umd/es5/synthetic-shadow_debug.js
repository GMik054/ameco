(function (factory) {
  ...
  var _prototype = Array.prototype, ArrayFilter = _prototype.filter, ArrayFind = _prototype.find, ArrayIndexOf = _prototype.indexOf, ArrayMap = _prototype.map, ArrayPush = _prototype.push, ArrayReduce = _prototype.reduce, ArrayReverse = _prototype.reverse, ArraySlice = _prototype.slice, ArraySplice = _prototype.splice, forEach = _prototype.forEach;
  ...
  var DOCUMENT_POSITION_CONTAINED_BY = _Node.DOCUMENT_POSITION_CONTAINED_BY, DOCUMENT_POSITION_PRECEDING = _Node.DOCUMENT_POSITION_PRECEDING, DOCUMENT_POSITION_FOLLOWING = _Node.DOCUMENT_POSITION_FOLLOWING, ELEMENT_NODE = _Node.ELEMENT_NODE, TEXT_NODE = _Node.TEXT_NODE, CDATA_SECTION_NODE = _Node.CDATA_SECTION_NODE, PROCESSING_INSTRUCTION_NODE = _Node.PROCESSING_INSTRUCTION_NODE, COMMENT_NODE = _Node.COMMENT_NODE;
  ...
  var _prototype4 = Document.prototype, querySelectorAll = _prototype4.querySelectorAll, getElementById = _prototype4.getElementById, getElementsByClassName = _prototype4.getElementsByClassName, getElementsByTagName = _prototype4.getElementsByTagName, getElementsByTagNameNS = _prototype4.getElementsByTagNameNS;
